...
export const VERSION_CONFIG = {
  ...
  minor: 15,      // Version mineure - nouvelles fonctionnalités
  patch: 3,      // Version patch - corrections de bugs
  buildDate: "2025-10-07", // Date de build automatique
};
...
export const VERSION_HISTORY = [
  {
    ...
    date: "2025-10-07",
    type: "PATCH",
    description: "Ajout du support des fichiers tableurs CSV, XLS et XLSX dans les pièces jointes des tickets"
  },
{
    version: "2.15.2",
    date: "2025-10-02",
    type: "PATCH",
    description: "Ajout du support des fichiers XML dans les pièces jointes des tickets"
  },
{
    version: "2.15.1",
    date: "2025-09-18",
    type: "PATCH",
    description: "Ajout du nom de la société client dans la liste des tickets (vue messagerie) pour une meilleure identification"
  },
{
    version: "2.15.0",
    date: "2025-09-18",
    type: "MINOR",
    description: "Améliorations du Dashboard : extension de l'évolution des tickets à 30 jours avec dates formatées au format français, et correction du Top 5 Clients pour afficher correctement les statistiques de tickets par client"
  },
{
    version: "2.14.0",
    date: "2025-09-18",
  ...
  },
{
    ...
    date: "2025-09-12",
    type: "MINOR",
    description: "Amélioration des emails : ajout du nom du client dans l'objet et le corps des emails de commentaires et changements de statut pour tickets, portabilités et productions"
  },
{
    version: "2.11.0",
    date: "2025-09-09",
